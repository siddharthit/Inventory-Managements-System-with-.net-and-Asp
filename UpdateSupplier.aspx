<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateSupplier.aspx.cs" Inherits="Supplier" %>
    ...
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style7">
                    <asp:Button ID="Button2" runat="server" Text="Update" Width="101px" OnClick="Button2_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style5">
            ...
            <tr>
                ...
                <td class="auto-style7">
                    <asp:Button ID="Button4" runat="server" Text="Psearch" Width="101px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
